          ...
          Expanded(
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: paymentOptions[selectedIndex],
              ),
            ),
          ),
        ],
...
class CategoriesPayemnt extends StatefulWidget {
  ...
  CategoriesPayemnt({required this.selectedIndex, required this.onCategorySelected});
          ...
          children: <Widget>[
            Text(
              ...
              style: TextStyle(
                ...
                color: widget.selectedIndex == index ? TColors.primary : TColors.darkGrey,
              ),
            ),
            Container(
              ...
              height: 2,
              width: 30,
              color: widget.selectedIndex == index ? TColors.primary : Colors.transparent,
            ),
          ],
        ),
      ),
...
class CibEdahabia extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
          ...
          Center(
            child: ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                foregroundColor: TColors.secondary, backgroundColor: TColors.primary,
...
class VirementBancaire extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(20.0),
...
class Cheque extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(20.0),
...
class BaridiMob extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(20.0),
